...
{
    public partial class FormFaturasPagas : Form
    {
        private int codigoTitular;
        public FormFaturasPagas(int codigoTitular)
        {
            InitializeComponent();
        ...
        private void FormFaturasPagas_Load(object sender, EventArgs e)
        {
            Conexao db = new Conexao();
            db.Conectar();
            List<Fatura> faturas = db.ConsultaFaturaPaga(codigoTitular);
